    ...
    public partial class Initial_PostgreSQL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppContentReports", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubCategory = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ...
                    Seasons = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ...
                    OriginalImageUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    CutoutImageUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppGarments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    GarmentIdsJson = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    ComboHash = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    HarmonyScore = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    RenderUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    Visibility = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOutfits", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionVoteCountsJson = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPolls", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPollVotes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppRenderCaches",
                columns: table => new
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    RenderUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRenderCaches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasFace = table.Column<bool>(type: "boolean", nullable: false),
                    IsFullBody = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudioPhotoUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    Package = table.Column<int>(type: "integer", nullable: false),
                    DailyRenderCount = table.Column<int>(type: "integer", nullable: false),
                    DailyRenderCountResetAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    BodyType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppContentReports_ReporterUserId",
                table: "AppContentReports",
                column: "ReporterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppContentReports_TenantId_Status",
                table: "AppContentReports",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AppGarments_Category",
                table: "AppGarments",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_AppGarments_TenantId_UserId_Category",
                table: "AppGarments",
                columns: new[] { "TenantId", "UserId", "Category" });

            migrationBuilder.CreateIndex(
                name: "IX_AppGarments_UserId",
                table: "AppGarments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppOutfits_ComboHash",
                table: "AppOutfits",
                column: "ComboHash");

            migrationBuilder.CreateIndex(
                name: "IX_AppOutfits_TenantId_UserId",
                table: "AppOutfits",
                columns: new[] { "TenantId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppOutfits_UserId",
                table: "AppOutfits",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPolls_CreatorUserId",
                table: "AppPolls",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPolls_TenantId_IsPublished",
                table: "AppPolls",
                columns: new[] { "TenantId", "IsPublished" });

            migrationBuilder.CreateIndex(
                name: "IX_AppPollVotes_PollId_UserId",
                table: "AppPollVotes",
                columns: new[] { "PollId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppPollVotes_TenantId",
                table: "AppPollVotes",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRenderCaches_TenantId",
                table: "AppRenderCaches",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserBlocks_BlockerId_BlockedId",
                table: "AppUserBlocks",
                columns: new[] { "BlockerId", "BlockedId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUserBlocks_TenantId",
                table: "AppUserBlocks",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserFollows_FollowerId_FollowingId",
                table: "AppUserFollows",
                columns: new[] { "FollowerId", "FollowingId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUserFollows_TenantId",
                table: "AppUserFollows",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserPhotos_TenantId_UserId",
                table: "AppUserPhotos",
                columns: new[] { "TenantId", "UserId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_TenantId",
                table: "AppUserProfiles",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWishlistItems_TenantId_UserId_ContentType_ContentId",
                table: "AppWishlistItems",
                columns: new[] { "TenantId", "UserId", "ContentType", "ContentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppWishlistItems_UserId",
                table: "AppWishlistItems",
                column: "UserId");
